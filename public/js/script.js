...
function shrink()
{
    $('.navbar').addClass("shrink");
        ...
        $('.navbar .navbar-brand.orange_logo> img').attr('src', '../imgs/astick.png');
        ...
        $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', '../imgs/astick.png');
        ...
        $('.active-navbar .navbar .navbar-brand.orange_logo> img').attr('src', '../imgs/astick copy.png');
...
function extend() {
    ...
    $('.index-light .navbar .navbar-brand.yellow_logo> img').attr('src', 'images/logo-yellow-dark.png');
    $('.index-light .navbar .navbar-brand.pink_logo> img').attr('src', 'images/logo-pink-dark.png');
    $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', '../imgs/astick copy.png');
